...
import MyCourses from './components/core/Dashboard/MyCoursesinstr/MyCourses';
...
function App() {
  ...
  <div className='w-screen min-h-screen bg-[#172554] flex flex-col font-inter'>
    <NavBar/>
      ...
      >
          ...
          {user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
            <>
              ...
              <Route path="dashboard/instructor/:courseId" element={<InstructorIndividualCourse />} />
              <Route path="dashboard/edit-course/:courseId" element={<EditCourse />} />
            </>
          )}
      </Route>

      {/* watching lecture routes */}
      <Route element={
        <PrivateRoute>
          <ViewCourse/>
        </PrivateRoute>
