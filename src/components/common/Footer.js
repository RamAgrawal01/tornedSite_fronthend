...
// Images
import StudyNotionLogo from "../../assets/torned_logo-removebg-preview.png";
...
const Footer = () => {
  return (
    <div className="bg-navyblue-900 mx-7 rounded-3xl mb-10">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-navyblue-200 leading-6 mx-auto relative py-14">
      ...
      {/* bottom footer */}
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-navyblue-400 mx-auto pb-14 text-sm">
        {/* Section 1 */}
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='https://github.com/RamAgrawal01' target="__blank" className="text-white hover:underline mr-1"
              >
                Ram Agrawal
              </Link>
            </div>
            <span> © 2024 Torned Education</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/ram-agrawal-267a38221/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/RamAgrawal01" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
