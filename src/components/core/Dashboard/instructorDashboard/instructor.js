   ...
   const getCourseDataWithStats = async() => {
    ...
    return(
        ...
        <div>
            ...
            <div className='my-4 flex h-[450px] space-x-8'>
          ...
          >
            {instructorData.map((course,index)=>(
                ...
                <Link to={`/dashboard/instructor/${course._id}`}>
                   <div className="flex flex-col gap-2 border border-navyblue-600 bg-navyblue-700 p-3 text-[15px] text-navyblue-50 min-h-[180px]
                max-h-[500px] rounded-xl w-[360px]">
                        <Img
